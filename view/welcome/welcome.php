<!--Main Menu Start-->
    <header class="header-section">
        ...
        <nav class="main-menu">
        	<ul>
            	<li class="menu-active">
            		<a href="index.html">HOME</a><div class="hover-active"></div>
                	<ul>
        ...
        <nav class="social-main">
        	<ul>
            	<li><a href="#"><img src="/public/images/social-icon/social-icon-facebook.png" alt="Facebook" onMouseOver="this.src='/public/images/social-icon/social-icon-facebook-hover.png';" onMouseOut="this.src='/public/images/social-icon/social-icon-facebook.png';" /></a></li>
                <li><a href="#"><img src="/public/images/social-icon/social-icon-twitter.png" alt="Twitter" onMouseOver="this.src='/public/images/social-icon/social-icon-twitter-hover.png';" onMouseOut="this.src='/public/images/social-icon/social-icon-twitter.png';" /></a></li>
                <li><a href="#"><img src="/public/images/social-icon/social-icon-pinterest.png" alt="Pinterest" onMouseOver="this.src='/public/images/social-icon/social-icon-pinterest-hover.png';" onMouseOut="this.src='/public/images/social-icon/social-icon-pinterest.png';" /></a></li>
                <li><a href="#"><img src="/public/images/social-icon/social-icon-google-plus.png" alt="Google Plus" onMouseOver="this.src='/public/images/social-icon/social-icon-google-plus-hover.png';" onMouseOut="this.src='/public/images/social-icon/social-icon-google-plus.png';" /></a></li>
                <li><a href="#"><img src="/public/images/social-icon/social-icon-feed.png" alt="Feed" onMouseOver="this.src='/public/images/social-icon/social-icon-feed-hover.png';" onMouseOut="this.src='/public/images/social-icon/social-icon-feed.png';" /></a></li>
            </ul>
        </nav>
        <!--Social Media End-->
            ...
            <section class="banner-slide">
                <div id="layerslider" style="width: 1024px; height: 502px;">
                    ...
                    <div class="ls-slide" style="transition2d: 8,49,77,100,105; slidedelay: 8000;">
                        ...
                        <!--Slider Background-->
                        <img class="ls-bg" src="/public/images/slider/slider1.jpg" alt="layer1-background" />
                    ...
                    <div class="ls-slide" style="transition2d: 8,49,77,100,105; slidedelay: 8000;">
                        ...
                        <!--Slider Background-->
                        <img class="ls-bg" src="/public/images/slider/slider2.jpg" alt="layer2-background">
                        <a href="#" class="ls-link"></a>
                    ...
                    <div class="ls-slide" style="transition2d: 8,49,77,100,105; slidedelay: 8000;">
                        ...
                        <!--Slider Background-->
                        <img class="ls-bg" src="/public/images/slider/slider3.jpg" alt="layer3-background">
                        <a href="#" class="ls-link"></a>
            	...
            	<ul>
                    	...
                    	<a href="service-single1.html">
                            <div class="flip-front">
                                <div class="service-icon">
                                    <img src="/public/images/service-icon/service-icon-1.png" alt="service" />
                                </div>
                    ...
                    <li class="flip">
                    	<a href="service-single2.html">
                            <div class="flip-front">
                                <div class="service-icon">
                                    <img src="/public/images/service-icon/service-icon-2.png" alt="service" />
                                </div>
                    ...
                    <li class="flip">
                    	<a href="service-single1.html">
                            <div class="flip-front">
                                <div class="service-icon">
                                    <img src="/public/images/service-icon/service-icon-3.png" alt="service" />
                                </div>
                    ...
                    <li class="flip">
                    	<a href="service-single2.html">
                            <div class="flip-front">
                                <div class="service-icon">
                                    <img src="/public/images/service-icon/service-icon-4.png" alt="service" />
                                </div>
                	...
                	<div class="large-grid flip">
                        <div class="flip-front">
                            <a href="blog-single.html">
                                <figure>
                                    <img src="/public/images/upload/large-thumbnail1.jpg" alt="image" />
                                </figure>
                            </a>
                        </div>
                        <div class="flip-back">
                    ...
                    <ul class="small-grid">
                    	...
                    	<li class="flip">
                        	<div class="flip-front">
                            	<a href="blog-single.html">
                                	<figure>
                                    	<img src="/public/images/upload/small-thumbnail1.jpg" alt="image" />
                                    </figure>
                                </a>
                            </div>
                            <a href="blog-single.html">
                	...
                	<ul class="small-grid">
                        ...
                        <li class="flip">
                        	<div class="flip-front">
                            	<a href="blog-single.html">
                                	<figure>
                                    	<img src="/public/images/upload/small-thumbnail2.jpg" alt="image" />
                                    </figure>
                                </a>
                            </div>
                            <a href="blog-single.html">
            ...
            <section class="container portfolio">
            	<ul>
                	<li class="item">
                        <div class="box-title">
                            <div class="icon">
                                <img src="/public/images/service-icon/service-icon-5.png" alt="service" />
                            </div>
                            <h2>PORTFOLIO</h2>
                        </div>
                    </li>
                    ...
                    <li class="flip">
                        <div class="flip-front">
                            <a href="portfolio-single.html">
                                <figure>
                                    <img src="/public/images/upload/portfolio-thumbnail-06.jpg" alt="image" />
                                </figure>
                            </a>
                        </div>
                        <a href="portfolio-single.html">
                    ...
                    <li class="flip">
                        <div class="flip-front">
                            <a href="portfolio-single.html">
                                <figure>
                                    <img src="/public/images/upload/portfolio-thumbnail-13.jpg" alt="image" />
                                </figure>
                            </a>
                        </div>
                        <a href="portfolio-single.html">
                    ...
                    <li class="flip">
                        <div class="flip-front">
                            <a href="portfolio-single.html">
                                <figure>
                                    <img src="/public/images/upload/portfolio-thumbnail-03.jpg" alt="image" />
                                </figure>
                            </a>
                        </div>
                        <a href="portfolio-single.html">
                    ...
                    <li class="flip">
                        <div class="flip-front">
                            <a href="portfolio-single.html">
                                <figure>
                                    <img src="/public/images/upload/portfolio-thumbnail-14.jpg" alt="image" />
                                </figure>
                            </a>
                        </div>
                        <a href="portfolio-single.html">
                    ...
                    <li class="flip">
                        <div class="flip-front">
                            <a href="portfolio-single.html">
                                <figure>
                                    <img src="/public/images/upload/portfolio-thumbnail-11.jpg" alt="image" />
                                </figure>
                            </a>
                        </div>
                        <a href="portfolio-single.html">
                    ...
                    <li class="flip">
                        <div class="flip-front">
                            <a href="portfolio-single.html">
                                <figure>
                                    <img src="/public/images/upload/portfolio-thumbnail-04.jpg" alt="image" />
                                </figure>
                            </a>
                        </div>
                        <a href="portfolio-single.html">
                    ...
                    <li class="flip">
                        <div class="flip-front">
                            <a href="portfolio-single.html">
                                <figure>
                                    <img src="/public/images/upload/portfolio-thumbnail-05.jpg" alt="image" />
                                </figure>
                            </a>
                        </div>
                        <a href="portfolio-single.html">
